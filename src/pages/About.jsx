    ...
    <Layout seoProps={{
      ...
      <section className="pt-24 pb-20 bg-gradient-to-br from-primary/10 to-accent/10">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">About EarthMovers Rental</h1>
            ...
            <div>
              ...
              <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-6">
                ...
                <div className="text-center">
                  ...
                  <div className="text-gray-600">Modern Machines</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-primary">30+</div>
                  <div className="text-gray-600">Skilled Operators</div>
                </div>
                <div className="text-center">
      ...
      <section className="section-padding bg-gray-50">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Team Strength</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="card p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold">30+ Skilled Operators</h3>
            ...
            <div className="card p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold">Safety & Training</h3>
