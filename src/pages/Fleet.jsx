    ...
    <Layout seoProps={{
      ...
      <section className="pt-24 pb-20 bg-gradient-to-br from-primary/10 to-secondary/10">
        <div className="container-custom text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Our Equipment Fleet</h1>
        ...
        <div className="container-custom">
          <div className="flex flex-wrap justify-center items-center gap-8">
            <div className="text-center">
              ...
              <div className="text-sm">Equipment Types</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold">{totalUnits}</div>
              <div className="text-sm">Total Units Available</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold">30+</div>
              <div className="text-sm">Skilled Operators</div>
            </div>
            <div className="text-center">
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="bg-gray-50 rounded-2xl p-8">
            <h2 className="text-2xl font-bold mb-6 text-center">Why Choose Our Equipment</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="text-4xl mb-4">🔧</div>
                <h3 className="text-xl font-bold mb-3">Well-Maintained</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="card p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold mb-2">Operator Services</h3>
                    <p className="text-gray-600">
