...
const Home = () => {
  ...
  return (
    <Layout seoProps={{
        ...
        <div className="container-custom relative z-20 px-4">
          <div className="max-w-3xl text-white animate-slide-in">
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                to="/fleet"
                className="bg-[#808080] hover:bg-gray-500 font-semibold text-black text-lg px-8 py-4 rounded-lg transition duration-300"
              >
                View Our Fleet
              </Link>
              <Link
                to="/contact"
                className="border-2 border-white text-white hover:bg-[#C0C0C0] hover:text-white hover:border-[#C0C0C0] text-lg px-8 py-4 rounded-lg transition duration-300 font-semibold"
              >
                Get Free Quote
              </Link>
              <a
        ...
        <div className="container-custom">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {WHY_CHOOSE_US.map((item, index) => (
              <div
                key={index}
                className="card text-center p-8 hover:border-primary hover:border-2 transition-all duration-300"
              >
      ...
      {/* Stats Section */}
      <section className="section-padding bg-[#808080] text-white">
        <div className="container-custom">
      ...
      <section className="section-padding bg-[#C0C0C0]">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-800 ">Featured Equipment</h2>
            <p className="text-gray-700 max-w-2xl mx-auto font-semibold">
          ...
          <div className="text-center mt-8">
            <Link
              to="/fleet"
              className="inline-flex items-center bg-gray-600 hover:bg-gray-500 text-white text-lg font-bold px-8 py-3 rounded-lg transition duration-300"
            >
              View All Equipment
            </Link>
          </div>
